...
<head>
    ...
    <title>Events</title><!--This is what the tab is-->
    <!-- EmbedFont-->
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <button type="button" class="btn-custom" data-toggle="modal" data-target="#basicExampleModal">
                        New Event
                    </button>
                                ...
                                <div class="modal-body">
                                    <form>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="EventStartDate" placeholder="Start Date">
                                        </div>
                                        <div class="form-group">
                                            <label for="EventEndDate">End Date</label>
                                            <input type="date" class="form-control" id="EventEndDate" placeholder="End Date">
                                        </div>
                                        <div class="form-group">
                                            <label for="EventSartTime">Start Time</label>
                                            <input type="time" class="form-control" id="EventSartTime" placeholder="Start Time">
                                        </div>
                                        <div class="form-group">
                                            <label for="EventEndTime">End Time</label>
                                            <input type="time" class="form-control" id="EventendTime" placeholder="End Time">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="EventVolunteerLimit">Volunteer Limit</label>
                                            <input type="number" class="form-control" id="EventVolunteerLimit" placeholder="Limit">
                                        </div>
                                    </form>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="card h-100">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <!--Title-->
                                            <h4 class="card-title"><?php echo $row["E_name"]?></h4>
                                            <!--Text-->
